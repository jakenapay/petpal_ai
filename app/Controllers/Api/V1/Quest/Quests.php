...
class Quests extends BaseController
{
    ...
    public function dailyQuestExtraRewards(){
        ...
        $extraRewards = $dailiesExtraRewardsModel->getExtraRewards($userId) ?? [];
        ...
        return $this->response->setJSON([
            'message' => 'Completed tasks count for the user this week',
            'data' => [
    ...
    public function claimExtraReward(){
        ...
        $dailiesExtraRewardsModel = new DailiesExtraRewardsModel();
        $weeklyExtraRewardsModel = new \App\Models\WeeklyExtraRewardsModel();
